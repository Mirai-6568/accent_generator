...
from espnet2.tts.transformer_accent import TransformerAccent
...
tts_choices = ClassChoices(
    ...
    classes=dict(
        ...
        transformer_accent=TransformerAccent,
        fastspeech=FastSpeech,
        fastspeech2=FastSpeech2,
        fastspeech2_accent=FastSpeech2Accent,
    ),
    type_check=AbsTTS,
    default="tacotron2",
)
...
class TTSTask(AbsTask):
    ...
    def optional_data_names(
        ...
        if not inference:
            retval = ("accent", "spembs", "durations", "pitch", "energy")
        else:
            # Inference mode
            retval = ("accent", "spembs", "speech", "durations")
        return retval
